<%-- 
    ...
    Created on : 27 Jun, 2022, 9:54:45 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="align_right">
            ...
            <a class="link" href="booklisting.jsp?uname=<%=uname%>&uid=<%=uid%>">Book Listing</a>  | <a href="viewcart.jsp?uname=<%=uname%>&uid=<%=uid%>" class="link">View Cart</a> | <a class="link" href="logout.jsp">LOG OUT</a><br>
                <div class="cart1">
    ...
    <a class="link" href="updateprofile.jsp?uname=<%=uname%>&uid=<%=uid%>">Update Profile</a> 
</div>
<div class="title2">
