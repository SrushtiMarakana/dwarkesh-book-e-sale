<%-- 
    Document   : updateproductseller
    Created on : 4 Jul, 2022, 5:58:29 PM
    Author     : Dell
--%>
...
<div class="accountbody">
    <form method="post" action="updateproductsellerdb.jsp">
    <div class="register_align_left">
        ...
        <input class="form_input" type="number" name="price" value="<%=price%>" required=""><br><br>
